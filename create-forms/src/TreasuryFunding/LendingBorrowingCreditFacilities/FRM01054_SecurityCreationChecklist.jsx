// FRM01054_SecurityCreationChecklist.jsx
// FRM-01054 – Security Creation Checklist
...
const initialValues = {
  ...
  checklistItems: [
    ...
    { item: "Charge Registration Initiated", status: "", remarks: "", dynamicFields:{} },
    { item: "Collateral Valuation Completed", status: "", remarks: "", dynamicFields:{} },
    { item: "Insurance Coverage Verified", status: "", remarks: "", dynamicFields:{} },
    { item: "Legal Opinion Obtained", status: "", remarks: "", dynamicFields:{} },
    { item: "Lien / Hypothecation Created", status: "", remarks: "", dynamicFields:{} },
    { item: "Covenant Conditions Met", status: "", remarks: "", dynamicFields:{} },
    { item: "Regulatory Filings Completed", status: "", remarks: "", dynamicFields:{} },
    { item: "Internal Approval Completed", status: "", remarks: "", dynamicFields:{} },
    { item: "Original Documents Stored Safely", status: "", remarks: "", dynamicFields:{} }
  ],
...
const FRM01054_SecurityCreationChecklist = () => {
  ...
  return (
    <ModernFormWrapper
      formId="FRM-01054"
      title="Security Creation Checklist"
    >
      <Formik
        ...
        onSubmit={(values)=>{
          console.log(values);
          alert("Security Creation Checklist Submitted Successfully");
        }}
      >
              ...
              {!isPrintMode &&
                <div className="form-actions">
                  <button type="submit" className="btn-submit">
                    Submit Security Creation Checklist
                  </button>
                </div>
              }
...
export default FRM01054_SecurityCreationChecklist;