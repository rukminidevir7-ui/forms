// FRM00775_AccountingPolicyUpdate.jsx
// FRM-00775 – Accounting Policy Update – Request / Initiation
// Enterprise Grade – Compliance + Workflow + Custom Signatures
...
const FRM00775_AccountingPolicyUpdate = () => {
  ...
  return (
    <ModernFormWrapper
      formId="FRM-00775"
      title="Accounting Policy Update – Request"
    >
      <Formik
        ...
        onSubmit={(values)=>{
          console.log(values);
          alert("Accounting Policy Update Submitted Successfully");
        }}
      >
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {renderField(values,"updateId","Update ID")}
              ...
              <div className="form-section">
                <h3 className="form-section-title">Policy Update Details</h3>
                <div className="form-fields">
                  ...
                  {renderField(values,"reasonForUpdate","Reason for Update")}
                  {renderField(values,"summaryOfChanges","Summary of Changes")}
                  {renderField(values,"impactOnFinancialStatements","Impact on Financial Statements")}
                  {renderField(values,"systemsProcessImpact","Systems / Process Impact")}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {renderField(values,"regulatoryReference","Regulatory / Standard Reference")}
                  {renderField(values,"riskAssessment","Risk Assessment")}
                  {renderField(values,"controlsRequired","Controls Required")}
...
export default FRM00775_AccountingPolicyUpdate;
