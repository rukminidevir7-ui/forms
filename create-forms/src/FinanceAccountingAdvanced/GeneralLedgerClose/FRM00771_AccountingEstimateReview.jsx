// FRM00771_AccountingEstimateReview.jsx
// FRM-00771 – Accounting Estimate Review – Request / Initiation
...
const FRM00771_AccountingEstimateReview = () => {
  ...
  const calculateVariance = (prior, current) => {
  ...
  return (
    <ModernFormWrapper formId="FRM-00771" title="Accounting Estimate Review – Initiation">
      ...
      <Formik
        ...
        onSubmit={(values)=>{
          console.log(values);
          alert("Accounting Estimate Review Submitted Successfully");
        }}
      >
        {({ values, setFieldValue })=>(
          <Form>
            <ModernA4Template
              formId="FRM-00771"
              title="ACCOUNTING ESTIMATE REVIEW – REQUEST"
            ...
            >
              ...
              {/* ESTIMATE DETAILS */}
              <div className="form-section">
                <h3 className="form-section-title">Estimate Details</h3>
                  ...
                  {({ push, remove })=>(
                    <>
                      ...
                      <table className="items-table">
                        ...
                        <tbody>
                          {values.estimates.map((row,index)=>(
                            <tr key={index}>
                              <td><Field name={`estimates.${index}.estimateName`} className="form-input"/></td>
                              <td><Field name={`estimates.${index}.glCode`} className="form-input"/></td>
                              <td><Field name={`estimates.${index}.description`} className="form-input"/></td>
                              <td><Field name={`estimates.${index}.methodology`} className="form-input"/></td>
                              <td><Field name={`estimates.${index}.keyAssumptions`} className="form-input"/></td>
                              <td><Field name={`estimates.${index}.priorAmount`} type="number" className="form-input"/></td>
                              <td>
                                <Field
                                  name={`estimates.${index}.currentAmount`}
                                  type="number"
                                  ...
                                  onBlur={(e)=>{
                                    ...
                                    setFieldValue(`estimates.${index}.variance`,variance);
                                  }}
                                />
                              </td>
                              <td>
                                {isPrintMode
                                  ...
                                  : <Field name={`estimates.${index}.variance`} readOnly className="form-input"/>}
                              </td>

                              {dynamicColumns.map(col=>(
                                <td key={col.key}>
                                  <Field name={`estimates.${index}.dynamicFields.${col.key}`} className="form-input"/>
                                </td>
                              ))}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {renderField(values,"sensitivityAnalysis","Sensitivity Analysis")}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {renderField(values,"accountingStandardReference","Accounting Standard Reference")}
              ...
              {!isPrintMode && (
                <div className="form-actions">
                  <button type="submit" className="btn-submit">
                    Submit Accounting Estimate Review
                  </button>
                </div>
              )}
...
export default FRM00771_AccountingEstimateReview;
