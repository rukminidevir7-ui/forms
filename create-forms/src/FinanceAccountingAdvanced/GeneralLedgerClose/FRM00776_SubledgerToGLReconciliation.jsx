// FRM00776_SubledgerToGLReconciliation.jsx
// FRM-00776 – Sub-ledger to GL Reconciliation – Request / Initiation
// Enterprise Grade – Dynamic + Reconciliation Logic + Custom Signatures
...
const validationSchema = Yup.object({
  ...
  reconciliationId: Yup.string().required("Required"),
...
const FRM00776_SubledgerToGLReconciliation = () => {
  ...
  const calculateDifference = (subLedger, gl) => {
    const s = parseFloat(subLedger) || 0;
    const g = parseFloat(gl) || 0;
  ...
  return (
    <ModernFormWrapper
      formId="FRM-00776"
      title="Sub-ledger to GL Reconciliation – Request"
    >
      <Formik
      ...
      >
        {({ values, setFieldValue })=>(
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00776"
              title="SUB-LEDGER TO GL RECONCILIATION"
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {renderField(values,"reconciliationId","Reconciliation ID")}
              ...
              <div className="form-section">
                ...
                <FieldArray name="reconciliations">
                  {({ push, remove })=>(
                    <>
                      {!isPrintMode && (
                      ...
                      <table className="items-table">
                        ...
                        <tbody>
                          {values.reconciliations.map((row,index)=>(
                            <tr key={index}>
                              <td><Field name={`reconciliations.${index}.subLedgerName`} className="form-input"/></td>
                              <td><Field name={`reconciliations.${index}.glAccountCode`} className="form-input"/></td>

                              <td>
                                <Field
                                  name={`reconciliations.${index}.subLedgerBalance`}
                                  type="number"
                              ...
                              <td>
                                <Field
                                  name={`reconciliations.${index}.glBalance`}
                                  type="number"
                                  className="form-input"
                                  onBlur={(e)=>{
                                    ...
                                    setFieldValue(`reconciliations.${index}.difference`, diff);
                                  }}
                                />
                              </td>
                              ...
                              <td>
                                {isPrintMode
                                  ...
                                  : <Field name={`reconciliations.${index}.difference`} readOnly className="form-input"/>}
                              </td>

                              <td><Field name={`reconciliations.${index}.materialityThreshold`} className="form-input"/></td>
                              <td><Field name={`reconciliations.${index}.lastReconciledDate`} type="date" className="form-input"/></td>
                              <td><Field name={`reconciliations.${index}.supportingReference`} className="form-input"/></td>

                              {dynamicColumns.map(col=>(
                                <td key={col.key}>
                                  <Field name={`reconciliations.${index}.dynamicFields.${col.key}`} className="form-input"/>
                                </td>
                              ))}
              ...
              {/* DIFFERENCE ANALYSIS */}
              <div className="form-section">
                <h3 className="form-section-title">Difference Analysis</h3>
                <div className="form-fields">
...
export default FRM00776_SubledgerToGLReconciliation;
