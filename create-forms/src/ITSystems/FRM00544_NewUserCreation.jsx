// FRM00544_NewUserCreation.jsx
// FRM-00544 / FRM-00545 – New User Creation Form
...
const validationSchema = Yup.object({
  ...
  systemAccess: Yup.string().required('Required'),
  roleAccessLevel: Yup.string().required('Required'),
  accessStartDate: Yup.string().required('Required'),

  backgroundCheck: Yup.string().required('Required'),
  dataAccessLevel: Yup.string().required('Required'),
  policyAcceptance: Yup.string().required('Required'),
...
const FRM00544_NewUserCreation = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-00544" title="New User Creation – Request & Approval">
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('New User Creation submitted successfully');
        }}
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00544"
              title="NEW USER CREATION – REQUEST & APPROVAL FORM"
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'joiningDate','Joining Date','date')}
                </div>
              </div>

              {/* 3. Account Requirements */}
              <div className="form-section">
                <h3 className="form-section-title">3. Account Requirements</h3>
                <div className="form-fields">
                  {field(values,'username','User ID / Username')}
                  {field(values,'emailRequired','Email Account Required (Y/N)')}
                  {field(values,'systemAccess','System / Application Access')}
                  {field(values,'roleAccessLevel','Role / Access Level')}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {field(values,'backgroundCheck','Background Check Completed')}
                  {field(values,'dataAccessLevel','Data Access Level')}
                  {field(values,'policyAcceptance','Policy Acceptance')}
...
export default FRM00544_NewUserCreation;
