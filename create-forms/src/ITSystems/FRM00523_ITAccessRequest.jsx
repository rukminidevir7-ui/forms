// FRM00523_ITAccessRequest.jsx
// FRM-00523 – IT Access Request Form
...
const validationSchema = Yup.object({
  ...
  requiredFromDate: Yup.string().required('Required'),

  managerApprovalRequired: Yup.string().required('Required'),
  dataSensitivityLevel: Yup.string().required('Required'),
  complianceCheck: Yup.string().required('Required'),

  requestedBySignature: Yup.object(),
  managerSignature: Yup.object(),
  itApprovalSignature: Yup.object(),
...
const FRM00523_ITAccessRequest = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-00523" title="IT Access Request Form">
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('IT Access Request submitted successfully');
        }}
      >
          ...
          <Form>
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {field(values,'accessType','Access Type (New/Modify/Revoke)')}
                  {field(values,'systemName','System / Application Name')}
                  {field(values,'accessLevel','Access Level / Role')}
                  {textarea(values,'businessJustification','Business Justification')}
                  {field(values,'requiredFromDate','Required From Date','date')}
                  {field(values,'requiredToDate','Required To Date (if temporary)','date')}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {field(values,'managerApprovalRequired','Manager Approval Required')}
                  {field(values,'dataSensitivityLevel','Data Sensitivity Level')}
              ...
              <div className="form-section">
                ...
                <div className="three-column-signatures">
                  ...
                  <div className="signature-column">
                    <ApprovalSignatureBlock
                      label="IT Approval"
                      value={values.itApprovalSignature || {}}
                      onChange={(val) => setFieldValue("itApprovalSignature", val)}
                    />
                  </div>
...
export default FRM00523_ITAccessRequest;
