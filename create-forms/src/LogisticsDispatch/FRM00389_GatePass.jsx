// FRM00389_GatePass.jsx
// FRM-00389 – Gate Pass – Request / Initiation Form
...
const validationSchema = Yup.object({
  ...
  gatePassNo: Yup.string().required('Required'),
  ...
  securityCheckCompleted: Yup.string().required('Required'),
  itemsVerified: Yup.string().required('Required'),
  discrepancyObserved: Yup.string(),
  securityRemarks: Yup.string(),

  approvedBy: Yup.string().required('Required'),
  securityOfficer: Yup.string().required('Required'),
...
const FRM00389_GatePass = () => {
  ...
  return (
    <ModernFormWrapper
      formId="FRM-00389"
      title="Gate Pass – Request / Initiation Form"
    >
      <Formik
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'gatePassNo','Gate Pass No.')}
                  {field(values,'passType','Type (Inward / Outward)')}
                  {field(values,'requestedBy','Requested By')}
                  {field(values,'department','Department')}
                  {field(values,'validFrom','Valid From','date')}
                  {field(values,'validUntil','Valid Until','date')}
                </div>
              </div>

              {/* 2. Party / Transport Details */}
              <div className="form-section">
                <h3 className="form-section-title">2. Party / Transport Details</h3>
                <div className="form-fields">
                  {field(values,'partyName','Party / Visitor Name')}
                  {field(values,'companyName','Company / Organization')}
              ...
              <div className="form-section">
                <h3 className="form-section-title">4. Security Verification</h3>
                <div className="form-fields">
                  {field(values,'securityCheckCompleted','Security Check Completed')}
                  {field(values,'itemsVerified','Items Verified at Gate')}
                  {field(values,'discrepancyObserved','Discrepancy Observed')}
                  {textarea(values,'securityRemarks','Remarks')}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'securityOfficer','Security Officer')}
...
export default FRM00389_GatePass;
