// FRM01294_NonResidentToResidentTransferReview.jsx
// FRM-01294 – Non-Resident to Resident Transfer Review
...
const FRM01294_NonResidentToResidentTransferReview = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-01294" title="Non-Resident to Resident Transfer Review">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Non-Resident to Resident Transfer Review Submitted Successfully");
        }}
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-01294"
              title="FRM-01294 — Non-Resident to Resident Transfer Review"
            ...
            >
              ...
              {/* 3 */}
              <div className="form-section">
                <h3 className="form-section-title">Transferor (Non-Resident) Details</h3>
                <div className="form-fields">
              ...
              {/* 4 */}
              <div className="form-section">
                <h3 className="form-section-title">Transferee (Resident) Details</h3>
                <div className="form-fields">
...
export default FRM01294_NonResidentToResidentTransferReview;