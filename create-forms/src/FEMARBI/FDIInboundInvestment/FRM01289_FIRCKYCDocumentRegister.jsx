// FRM01289_FIRCKYCDocumentRegister.jsx
// FRM-01289 – FIRC & KYC Document Register Log
...
const FRM01289_FIRCKYCDocumentRegister = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-01289" title="FIRC & KYC Document Register Log">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("FIRC & KYC Register Submitted Successfully");
        }}
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-01289"
              title="FRM-01289 — FIRC & KYC Document Register Log"
            ...
            >
              ...
              {/* 2 Register Table */}
              <div className="form-section">
                <h3 className="form-section-title">FIRC & KYC Register Log</h3>
                      ...
                      <tbody>
                        {values.registerRows.map((row,index)=>(
                          <tr key={index}>
                            ...
                            <td><Field name={`registerRows.${index}.fircReference`} className="form-input"/></td>
                            <td><Field type="date" name={`registerRows.${index}.fircDate`} className="form-input"/></td>
                            <td><Field name={`registerRows.${index}.amount`} className="form-input"/></td>
                            <td><Field name={`registerRows.${index}.kycStatus`} className="form-input"/></td>
                            <td><Field name={`registerRows.${index}.documentLocation`} className="form-input"/></td>
...
export default FRM01289_FIRCKYCDocumentRegister;