// RecruiterVendorEmpanelmentRequest.jsx
// (Repurposed for Recruitment MIS Update – same features, only fields changed)
...
const validationSchema = Yup.object({
	...
	currentDataIssue: Yup.string().required('Current Data Issue is required'),
...
const RecruiterVendorEmpanelmentRequest = () => {
								...
								<div className="form-fields">
									...
									<div className="form-field">
										...
										{isPrintMode ? (
											...
											<>
												<Field name="moduleProcessArea" className="form-input" placeholder="Recruitment / Hiring / Onboarding etc." />
									...
									<div className="form-field">
										...
										{isPrintMode ? (
											...
											<>
												<Field name="impactArea" className="form-input" placeholder="Reports / Dashboards / Integrations etc." />
...
export default RecruiterVendorEmpanelmentRequest;
