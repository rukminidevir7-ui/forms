// ExitClearanceRequestApproval.jsx
...
const validationSchema = Yup.object({
	...
	reasonForExit: Yup.string().required('Reason for Exit is required'),
	...
	// SECTION 2 – EXIT CLEARANCE DETAILS (BASIC)
	itAssetsReturned: Yup.string().required('IT Assets Returned status is required'),
	idAccessCardReturned: Yup.string().required('ID Card / Access Card Returned status is required'),
	knowledgeTransferCompleted: Yup.string().required('Knowledge Transfer Completed status is required'),
	handoverCompleted: Yup.string().required('Handover Completed status is required'),
	pendingRecoveries: Yup.string().required('Pending Recoveries is required'),
	...
	exitClearanceReferenceNumber: Yup.string().required('Exit Clearance Reference Number is required'),
	...
	finalClearanceDecision: Yup.string().required('Final Clearance Decision is required'),
...
const ExitClearanceRequestApproval = () => {
	const { isPrintMode } = usePrintMode();

	return (
		<ModernFormWrapper
			formId="FRM-EXIT-CLEARANCE"
		...
		>
			<Formik
				...
				onSubmit={(values) => {
					console.log('Exit Clearance form submitted:', values);
						...
						>
							...
							<div className="form-section">
								...
								<div className="form-fields">
									...
									<div className="form-field full-width">
										...
										{isPrintMode ? (
											<div className="print-value">
												{values.reasonForExit || '___________________'}
											</div>
										) : (
											<>
												<Field
													...
													rows="2"
												/>
												<ErrorMessage name="reasonForExit" component="div" className="form-error" />
											</>
										)}
									</div>
							...
							<div className="form-section">
								...
								<div className="form-fields">
									{[
										{
											name: 'itAssetsReturned',
											label: 'IT Assets Returned',
											options: ['Yes', 'No', 'NA']
										},
										{
											name: 'idAccessCardReturned',
											label: 'ID Card / Access Card Returned',
											options: ['Yes', 'No', 'NA']
										},
										{
										...
										<div key={f.name} className="form-field">
											...
											{isPrintMode ? (
												...
												<>
													<Field name={f.name} as="select" className="form-input">
									...
									<div className="form-field full-width">
										<label className="form-label required">
											Pending Recoveries (if any)
										</label>
										{isPrintMode ? (
											<div className="print-value">
												{values.pendingRecoveries || '___________________'}
											</div>
										) : (
											<>
												<Field
													...
													rows="2"
												/>
												<ErrorMessage name="pendingRecoveries" component="div" className="form-error" />
											</>
										)}
									</div>
							...
							<div className="form-section">
								...
								<div className="form-fields">
									<div className="form-field">
										<label className="form-label required">
											Exit Clearance Reference Number
										</label>
										{isPrintMode ? (
											<div className="print-value">
												{values.exitClearanceReferenceNumber || '___________________'}
											</div>
										) : (
											<>
												<Field name="exitClearanceReferenceNumber" className="form-input" />
												<ErrorMessage name="exitClearanceReferenceNumber" component="div" className="form-error" />
											</>
										)}
									</div>
									...
									<div className="form-field full-width">
										...
										{isPrintMode ? (
											<div className="print-value">
												{values.finalClearanceDecision || '___________________'}
											</div>
										) : (
											<>
												<Field
													name="finalClearanceDecision"
													as="textarea"
													className="form-textarea"
													rows="2"
												/>
												<ErrorMessage name="finalClearanceDecision" component="div" className="form-error" />
											</>
										)}
									</div>
...
export default ExitClearanceRequestApproval;
