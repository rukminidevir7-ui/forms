// FRM01479_ChemicalStorageChecklist.jsx
// FRM-01479 – Chemical Storage Checklist
...
const initialValues = {
  ...
  /* 3. Chemical Storage Checklist Items */
  chemicalChecklistItems: [
    {
      chemicalName: "",
      storageCondition: "",
      labelingStatus: "",
...
const FRM01479_ChemicalStorageChecklist = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01479" title="Chemical Storage Checklist">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Chemical Storage Checklist Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01479"
            title="FRM-01479 — Chemical Storage Checklist"
          ...
          {[
            ...
            ["Organization Details",[
              ...
              ["warehouseStorageLocation","Warehouse / Storage Location"]
            ]]
          ].map(([section,fields])=>(
          ...
          <div className="form-section">
            <h3 className="form-section-title">Chemical Storage Checklist Items</h3>
            ...
            {!isPrintMode &&
              <div style={{marginBottom:15}}>
                ...
                <button
                  ...
                  style={{marginLeft:10}}
                  onClick={() =>
                    setFieldValue("chemicalChecklistItems", [
                      ...values.chemicalChecklistItems,
                      {
                        chemicalName:"",
                        storageCondition:"",
                        labelingStatus:"",
            ...
            <FieldArray name="chemicalChecklistItems">
            {({remove})=>(
              <table className="items-table">
                <thead>
                  <tr>
                    ...
                    <th>Labeling Status</th>
                    <th>MSDS Available</th>
                    <th>Segregation Proper</th>
                    <th>Container Condition</th>
                    <th>Spill Control Available</th>
                ...
                <tbody>
                  {values.chemicalChecklistItems.map((row,index)=>(
                    <tr key={index}>
                      {["chemicalName","storageCondition","labelingStatus","msdsAvailable","segregationProper","containerCondition","spillControlAvailable","compliance","remarks"].map(field=>(
                        <td key={field}>
                          <Field
                            name={`chemicalChecklistItems.${index}.${field}`}
                      ...
                      {dynamicColumns.map(col=>(
                        <td key={col.key}>
                          <Field
                            name={`chemicalChecklistItems.${index}.dynamicFields.${col.key}`}
                            className="form-input"
                          />
                        </td>
                      ))}
          ...
          {!isPrintMode &&
            <div className="form-actions">
              <button type="submit" className="btn-submit">
                Submit Chemical Storage Checklist
              </button>
            </div>
          }
...
export default FRM01479_ChemicalStorageChecklist;