// FRM01470_PersonalHygieneDeclaration.jsx
// FRM-01470 – Personal Hygiene Declaration
...
const initialValues = {
  ...
  declarationFitnessToWork: "",

  /* 5. Hygiene Compliance */
  hygieneTrainingCompleted: "",
  lastTrainingDate: "",
  protectiveClothingProvided: "",
...
const FRM01470_PersonalHygieneDeclaration = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01470" title="Personal Hygiene Declaration">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Personal Hygiene Declaration Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01470"
            title="FRM-01470 — Personal Hygiene Declaration"
          ...
          {[
            ...
            ["Health Declaration",[
              ["medicalFitnessStatus","Medical Fitness Status (Fit / Unfit)"],
              ...
              ["declarationFitnessToWork","Declaration of Fitness to Work"]
            ]],
            ["Hygiene Compliance",[
              ["hygieneTrainingCompleted","Personal Hygiene Training Completed (Yes/No)"],
              ["lastTrainingDate","Last Training Date"],
              ["protectiveClothingProvided","Protective Clothing Provided (Yes/No)"],
          ...
          <div className="form-section">
            ...
            <div className="form-fields">
              <div className="form-field">
                ...
                <Field name="employeeSignature" className="form-input"/>
              </div>
              <div className="form-field">
                <label className="form-label">Supervisor Name</label>
                <Field name="supervisorName" className="form-input"/>
              </div>
            </div>
          ...
          {!isPrintMode &&
            <div className="form-actions">
              <button type="submit" className="btn-submit">
                Submit Personal Hygiene Declaration
              </button>
            </div>
          }
...
export default FRM01470_PersonalHygieneDeclaration;