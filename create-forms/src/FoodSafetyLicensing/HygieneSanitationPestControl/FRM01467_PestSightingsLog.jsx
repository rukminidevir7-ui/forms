// FRM01467_PestSightingsLog.jsx
// FRM-01467 – Pest Sightings Log
...
const initialValues = {
  ...
  /* 3. Pest Sightings Entries */
  pestSightingsEntries: [
    {
      sightingDate: "",
      sightingTime: "",
      location: "",
...
const FRM01467_PestSightingsLog = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01467" title="Pest Sightings Log">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Pest Sightings Log Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01467"
            title="FRM-01467 — Pest Sightings Log"
          ...
          <div className="form-section">
            <h3 className="form-section-title">Pest Sightings Entries</h3>
            ...
            {!isPrintMode &&
              <div style={{marginBottom:15}}>
                ...
                <button
                  ...
                  style={{marginLeft:10}}
                  onClick={() =>
                    setFieldValue("pestSightingsEntries", [
                      ...values.pestSightingsEntries,
                      {
                        sightingDate:"",
                        sightingTime:"",
                        location:"",
            ...
            <FieldArray name="pestSightingsEntries">
            {({remove})=>(
              <table className="items-table">
                ...
                <tbody>
                  {values.pestSightingsEntries.map((row,index)=>(
                    <tr key={index}>
                      {["sightingDate","sightingTime","location","pestType","activityObserved","severity","immediateAction","entryReportedBy","verifiedBy","remarks"].map(field=>(
                        <td key={field}>
                          <Field
                            name={`pestSightingsEntries.${index}.${field}`}
                            type={
                              field==="sightingDate" ? "date" :
                              field==="sightingTime" ? "time" :
                              "text"
                            }
                      ...
                      {dynamicColumns.map(col=>(
                        <td key={col.key}>
                          <Field
                            name={`pestSightingsEntries.${index}.dynamicFields.${col.key}`}
                            className="form-input"
                          />
                        </td>
                      ))}
...
export default FRM01467_PestSightingsLog;