// FRM01464_DailyCleaningChecklist.jsx
// FRM-01464 – Daily Cleaning Checklist
...
const FRM01464_DailyCleaningChecklist = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01464" title="Daily Cleaning Checklist">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Daily Cleaning Checklist Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01464"
            title="FRM-01464 — Daily Cleaning Checklist"
          ...
          <div className="form-section">
            <h3 className="form-section-title">Cleaning Checklist Items</h3>
            ...
            {!isPrintMode &&
              <div style={{marginBottom:15}}>
                ...
                <button
                  ...
                  style={{marginLeft:10}}
                  onClick={() =>
                    setFieldValue("cleaningChecklist", [
                      ...values.cleaningChecklist,
                      {
                        cleaningArea:"",
                        cleaningTask:"",
                        frequency:"",
            ...
            <FieldArray name="cleaningChecklist">
            {({remove})=>(
              <table className="items-table">
                ...
                <tbody>
                  {values.cleaningChecklist.map((row,index)=>(
                    <tr key={index}>
                      {["cleaningArea","cleaningTask","frequency","methodChemicalUsed","completed","checkedBy","remarks"].map(field=>(
                        <td key={field}>
                          <Field
                            name={`cleaningChecklist.${index}.${field}`}
                      ...
                      {dynamicColumns.map(col=>(
                        <td key={col.key}>
                          <Field
                            name={`cleaningChecklist.${index}.dynamicFields.${col.key}`}
                            className="form-input"
                          />
                        </td>
                      ))}
          ...
          {/* 5. Attachments — SAME AS PREVIOUS FORM */}
          <div className="form-section">
...
export default FRM01464_DailyCleaningChecklist;