// FRM01476_EquipmentCleaningValidation.jsx
// FRM-01476 – Equipment Cleaning Validation
...
const validationSchema = Yup.object({
  ...
  validationDate: Yup.string().required("Required"),
...
const initialValues = {
  ...
  equipmentType: "",
  equipmentLocation: "",
  productPreviouslyProcessed: "",

  /* 4. Cleaning Procedure Details */
  cleaningMethod: "",
  cleaningAgentChemicalUsed: "",
  cleaningFrequency: "",
  cleaningPerformedBy: "",
  cleaningDate: "",
...
const FRM01476_EquipmentCleaningValidation = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01476" title="Equipment Cleaning Validation">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Equipment Cleaning Validation Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01476"
            title="FRM-01476 — Equipment Cleaning Validation"
          ...
          {[
            ...
            ["Equipment Details",[
              ...
              ["productPreviouslyProcessed","Product Previously Processed"]
            ]],
            ["Cleaning Procedure Details",[
              ["cleaningMethod","Cleaning Method"],
              ["cleaningAgentChemicalUsed","Cleaning Agent / Chemical Used"],
              ["cleaningFrequency","Cleaning Frequency"],
              ["cleaningPerformedBy","Cleaning Performed By"],
            ...
            ["Validation Parameters",[
              ...
              ["deviationObserved","Deviation Observed (Yes/No)"],
                ...
                {fields.map(([name,label])=>(
                  <div className="form-field" key={name}>
                    ...
                    <Field
                      ...
                      as={["resultsSummary","deviationDetails","impactAssessment","correctiveActionRequired","preventiveAction"].includes(name) ? "textarea" : "input"}
          ...
          {!isPrintMode &&
            <div className="form-actions">
              <button type="submit" className="btn-submit">
                Submit Equipment Cleaning Validation
              </button>
            </div>
          }
...
export default FRM01476_EquipmentCleaningValidation;