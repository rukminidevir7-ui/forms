// FRM01457_FoodSafetyInternalAuditChecklist.jsx
// FRM-01457 – Food Safety Internal Audit Checklist
...
const validationSchema = Yup.object({
  auditNumber: Yup.string().required("Required"),
...
const initialValues = {
  ...
  auditChecklist: Array.from({ length: 17 }, (_, i) => ({
    slNo: i + 1,
    auditArea: "",
    checklistQuestion: "",
    requirement: "",
...
const FRM01457_FoodSafetyInternalAuditChecklist = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01457" title="Food Safety Internal Audit Checklist">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Food Safety Internal Audit Checklist Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01457"
            title="FRM-01457 — Food Safety Internal Audit Checklist"
          ...
          <div className="form-section">
            <h3 className="form-section-title">Audit Checklist Items</h3>
                ...
                <button
                  ...
                  onClick={() =>
                    setFieldValue("auditChecklist", [
                      ...
                      {
                        slNo: values.auditChecklist.length + 1,
                        auditArea:"",
                        checklistQuestion:"",
                        requirement:"",
                        compliance:"",
              ...
              <table className="items-table">
                ...
                <tbody>
                  {values.auditChecklist.map((row,index)=>(
                    <tr key={index}>
                      <td>{row.slNo}</td>
                      {["auditArea","checklistQuestion","requirement","compliance","evidence","observation","actionRequired","responsible"].map(field=>(
                        <td key={field}>
                          <Field
                            name={`auditChecklist.${index}.${field}`}
                            as={field==="checklistQuestion" || field==="observation" || field==="actionRequired" ? "textarea" : "input"}
                            className="form-input"
                          />
                        </td>
                      ))}
                      {dynamicColumns.map(col=>(
                        <td key={col.key}>
                          <Field
                            name={`auditChecklist.${index}.dynamicFields.${col.key}`}
                            className="form-input"
                          />
                        </td>
                      ))}
          ...
          <div className="form-section">
            ...
            <div className="form-fields">
              {[
                ["majorNonconformities","Major Nonconformities"],
                ["minorNonconformities","Minor Nonconformities"],
          ...
          {!isPrintMode &&
            <div className="form-actions">
              <button type="submit" className="btn-submit">
                Submit Internal Audit Checklist
              </button>
            </div>
          }
...
export default FRM01457_FoodSafetyInternalAuditChecklist;