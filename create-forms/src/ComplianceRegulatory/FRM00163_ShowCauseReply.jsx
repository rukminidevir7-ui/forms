// FRM00163_ShowCauseReply.jsx
// FRM-00163 – Show Cause Reply – Request / Authorization Form
...
const validationSchema = Yup.object({
  ...
  replyDueDate: Yup.string().required('Required'),
  subject: Yup.string().required('Required'),
  noticeSummary: Yup.string().required('Required'),

  // Reply Preparation
  replySummary: Yup.string().required('Required'),
  keyArguments: Yup.string().required('Required'),
  supportingAnalysis: Yup.string().required('Required'),

  // Review & Validation
  reviewedBy: Yup.string().required('Required'),
  legalValidation: Yup.string().required('Required'),
  risksImplications: Yup.string().required('Required'),
...
const FRM00163_ShowCauseReply = () => {
  ...
  return (
    ...
    <ModernFormWrapper
      formId="FRM-00163"
      title="Show Cause Reply – Request / Authorization Form"
    >
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('Show cause reply submitted successfully');
        }}
      >
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {select(values,'caseType','Case Type',['Show Cause Notice','Regulatory Violation Notice','Penalty Notice','Enforcement Action'])}
              ...
              {/* Notice Details */}
              <div className="form-section">
                <h3 className="form-section-title">2. Notice Details</h3>
                <div className="form-fields">
                  ...
                  {field(values,'replyDueDate','Reply Due Date','date')}
                  {field(values,'subject','Subject')}
                  {textarea(values,'noticeSummary','Notice Summary')}
                </div>
              </div>

              {/* Reply Preparation */}
              <div className="form-section">
                <h3 className="form-section-title">3. Reply Preparation</h3>
                <div className="form-fields">
                  {textarea(values,'replySummary','Reply Summary')}
                  {textarea(values,'keyArguments','Key Arguments / Points')}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'legalValidation','Legal Validation')}
                  {textarea(values,'risksImplications','Risks / Implications')}
                </div>
              </div>
...
export default FRM00163_ShowCauseReply;
