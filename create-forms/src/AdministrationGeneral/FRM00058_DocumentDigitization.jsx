// FRM00058_DocumentDigitization.jsx
// FRM-00058 – Document Digitization Request & Authorization Form
...
const validationSchema = Yup.object({
  ...
  requiredCompletionDate: Yup.string().required('Required'),

  // Scope & Instructions
  scopeDescription: Yup.string().required('Required'),
  indexingRequirements: Yup.string().required('Required'),
...
const FRM00058_DocumentDigitization = () => {
  ...
  return (
    ...
    <ModernFormWrapper
      formId="FRM-00058"
      title="Document Digitization Request & Authorization Form"
    >
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('Document digitization request submitted successfully');
        }}
      >
        ...
        {({ values, setFieldValue }) => (
          ...
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00058"
              title="Document Digitization – Request & Authorization"
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {select(values,'requestType','Request Type',['Backlog Digitization','New Record Digitization','Bulk Scanning','Indexing Only'])}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {select(values,'preferredFormat','Preferred Format',['PDF','Searchable PDF','TIFF','JPEG','Indexed PDF'])}
                  {field(values,'requiredCompletionDate','Required Completion Date','date')}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {textarea(values,'indexingRequirements','Indexing / Naming Requirements')}
...
export default FRM00058_DocumentDigitization;
