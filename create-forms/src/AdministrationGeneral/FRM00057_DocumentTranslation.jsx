// FRM00057_DocumentTranslation.jsx
// FRM-00057 – Document Translation Request & Authorization Form
...
const FRM00057_DocumentTranslation = () => {
  ...
  return (
    ...
    <ModernFormWrapper
      formId="FRM-00057"
      title="Document Translation Request & Authorization Form"
    >
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('Document translation request submitted successfully');
        }}
      >
        ...
        {({ values, setFieldValue }) => (
          ...
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00057"
              title="Document Translation – Request & Authorization"
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {select(values,'translationType','Translation Type',['Standard Translation','Certified Translation','Legal Translation','Technical Translation'])}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'sourceLanguage','Source Language')}
                  {field(values,'targetLanguage','Target Language')}
              ...
              {/* Scope & Instructions */}
              <div className="form-section">
                <h3 className="form-section-title">3. Scope & Instructions</h3>
                <div className="form-fields">
                  {textarea(values,'translationScope','Scope / Sections to Translate')}
                  {textarea(values,'specialInstructions','Special Instructions / Terminology')}
                  {select(values,'deliveryFormat','Delivery Format',['Editable Format','PDF','Hard Copy','Bilingual Document'])}
                </div>
              </div>
...
export default FRM00057_DocumentTranslation;
