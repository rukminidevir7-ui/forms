// FRM00001_OfficeSupplies.jsx
// FRM-00001 – Office Supplies Request & Authorization Form
...
const validationSchema = Yup.object({
  ...
  quantityRequested: Yup.number().required('Required'),
  estimatedUnitCost: Yup.number().required('Required'),
...
const FRM00001_OfficeSupplies = () => {
  ...
  return (
    ...
    <ModernFormWrapper
      formId="FRM-00001"
      title="Office Supplies Request & Authorization Form"
    >
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('Office Supplies request submitted successfully');
        }}
      >
        ...
        {({ values, setFieldValue }) => (
          ...
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00001"
              title="Office Supplies – Request & Authorization"
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'quantityRequested','Quantity Requested','number')}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {textarea(values,'supportingDocuments','Supporting Documents / Notes')}
                </div>
              </div>
...
export default FRM00001_OfficeSupplies;
