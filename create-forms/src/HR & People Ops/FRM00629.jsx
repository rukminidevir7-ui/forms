...
const validationSchema = Yup.object({
  ...
  proposedCommercialTerms: Yup.string().required('Proposed Commercial Terms is required'),
...
const FRM00629 = () => {
  ...
  const renderFormContent = (values, setFieldValue, errors, touched) => (
    <ModernA4Template formId="FRM-00629" title="Recruiter Vendor Empanelment – Approval/Authorization Form" department="HR & People Ops">
      {/* VENDOR INFORMATION */}
      ...
      <div className="form-section">
        ...
        <div className="form-fields">
          <div className="form-field full-width">
            <label className="form-label required">Proposed Commercial Terms</label>
            {isPrintMode ? (
              <div className="print-value">{values.proposedCommercialTerms || '___________________'}</div>
            ) : (
              <>
                <Field name="proposedCommercialTerms" as="textarea" className="form-textarea" placeholder="Enter proposed commercial terms and fee structure" rows="3" />
                <ErrorMessage name="proposedCommercialTerms" component="div" className="form-error" />
              </>
            )}
          </div>
          <div className="form-field">
          ...
          <div className="form-field">
            <label className="form-label required">Approved By (HR Head / Finance / Procurement)</label>
            {isPrintMode ? (
          ...
          <div className="form-field full-width">
            ...
            {isPrintMode ? (
              ...
              <>
                <Field name="approvalRemarksConditions" as="textarea" className="form-textarea" placeholder="Enter remarks and conditions" rows="2" />
  ...
  return (
    <ModernFormWrapper formId="FRM-00629" title="Recruiter Vendor Empanelment – Approval/Authorization Form">
