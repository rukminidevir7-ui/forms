...
const FRM00636 = () => {
  ...
  const renderFormContent = (values, setFieldValue) => (
    <ModernA4Template formId="FRM-00636" title="Candidate Rejection Communication – Approval" department="HR & People Ops">
      <div className="form-section">
        <h3 className="form-section-title">Candidate</h3>
      ...
      <div className="form-section">
        ...
        <div className="form-fields">
          ...
          <div className="form-field" style={{ marginTop: '15px' }}>
            ...
            {isPrintMode ? <div className="print-value" style={{ whiteSpace: 'pre-wrap' }}>{values.remarks || '___________________'}</div> : (
              <>
                <Field name="remarks" as="textarea" className="form-input" rows="3" />
  ...
  return (
    <ModernFormWrapper>
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={(values) => { console.log('Submit FRM00636', values); alert('Saved'); }}>
