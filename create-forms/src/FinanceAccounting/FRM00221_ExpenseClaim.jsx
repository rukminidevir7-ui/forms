// FRM00221_ExpenseClaim.jsx
// FRM-00221 – Expense Claim – Request / Initiation Form
...
const validationSchema = Yup.object({
  ...
  totalClaimAmount: Yup.string().required('Required'),
  paymentMethod: Yup.string().required('Required'),

  // 3. Expense Breakdown (summary level required)
  expenseSummary: Yup.string().required('Required'),
...
const FRM00221_ExpenseClaim = () => {
  ...
  return (
    ...
    <ModernFormWrapper
      formId="FRM-00221"
      title="Expense Claim – Request / Initiation Form"
    >
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,'claimDate','Claim Date','date')}
              ...
              {/* 2. Expense Details */}
              <div className="form-section">
                <h3 className="form-section-title">2. Expense Details</h3>
                <div className="form-fields">
                  ...
                  {field(values,'totalClaimAmount','Total Claim Amount','number')}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {textarea(values,'expenseSummary','Expense Breakdown (Date / Type / Description / Amount)')}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {select(values,'receiptsAttached','Receipts Attached',['Yes','No'])}
...
export default FRM00221_ExpenseClaim;
