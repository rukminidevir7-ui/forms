// FRM01264_DirectorResignationPack.jsx
// Director Resignation Pack – Universal Form
...
const validationSchema = Yup.object({
  ...
  effectiveResignationDate: Yup.string().required("Required")
});
...
const initialValues = {
  ...
  keyResponsibilitiesTransferred: "",
  handoverCompletedDate: "",
  successor: "",
  pendingMatters: "",

  complianceChecklist: [
    { item: "Resignation letter received", status: "", remarks: "", dynamicFields: {} },
    { item: "Board approval obtained", status: "", remarks: "", dynamicFields: {} },
    { item: "Regulatory filings prepared", status: "", remarks: "", dynamicFields: {} },
    { item: "Disclosure updates completed", status: "", remarks: "", dynamicFields: {} }
  ],
...
const FRM01264_DirectorResignationPack = () => {
  ...
  return (
    <ModernFormWrapper
      formId="FRM-01264"
      title="Director Resignation Pack"
    >
      <Formik
        ...
        onSubmit={(values)=>{
          console.log(values);
          alert("Director Resignation Pack Submitted Successfully");
        }}
      >
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,"effectiveResignationDate","Effective Resignation Date","date")}
                  {field(values,"reasonForResignation","Reason for Resignation")}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {field(values,"keyResponsibilitiesTransferred","Key Responsibilities Transferred")}
                  {field(values,"handoverCompletedDate","Handover Completed Date","date")}
                  {field(values,"successor","Successor (if any)")}
                  {field(values,"pendingMatters","Pending Matters")}
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {field(values,"resignationLetter","Resignation Letter")}
              ...
              {!isPrintMode &&
                <div className="form-actions">
                  <button type="submit" className="btn-submit">
                    Submit Director Resignation Pack
                  </button>
                </div>
              }
...
export default FRM01264_DirectorResignationPack;