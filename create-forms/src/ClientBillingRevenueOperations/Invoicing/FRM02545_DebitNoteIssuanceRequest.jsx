// FRM02545_DebitNoteIssuanceRequestUniversal.jsx
// FRM-02545 – Debit Note Issuance Request — Universal Form
...
const FRM02545_DebitNoteIssuanceRequestUniversal = () => {
  ...
  const calculateTotal = (values, setFieldValue) => {
    ...
    const total = adjustment + tax;
    setFieldValue("totalDebitNoteAmount", total.toFixed(2));
  };
  ...
  return (
    <ModernFormWrapper formId="FRM-02545" title="Debit Note Issuance Request">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Debit Note Issuance Request Submitted Successfully");
        }}
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-02545"
              title="FRM-02545 — Debit Note Issuance Request — Universal Form"
            ...
            >
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  {field(values,"reasonForDebitNote","Reason for Debit Note")}
              ...
              <div className="form-section">
                ...
                <div className="form-fields">
                  ...
                  {field(values,"taxes","Taxes","number",
                    ()=>calculateTotal(values,setFieldValue))}
                  {field(values,"totalDebitNoteAmount","Total Debit Note Amount")}
...
export default FRM02545_DebitNoteIssuanceRequestUniversal;