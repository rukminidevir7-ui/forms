// FRM02525_BillingRegisterUpdateLogUniversal.jsx
// FRM-02525 – Billing Register Update Log — Universal Form
...
const FRM02525_BillingRegisterUpdateLogUniversal = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-02525" title="Billing Register Update Log">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Billing Register Update Log Submitted Successfully");
        }}
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-02525"
              title="FRM-02525 — Billing Register Update Log"
              ...
              {!isPrintMode &&
                <div className="form-actions">
                  <button type="submit" className="btn-submit">
                    Submit Billing Register Update Log
                  </button>
                </div>
              }
...
export default FRM02525_BillingRegisterUpdateLogUniversal;