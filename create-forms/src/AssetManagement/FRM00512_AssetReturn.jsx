// FRM00512_AssetReturn.jsx
// FRM-00512 – Asset Return – Request & Approval Form
...
const FRM00512_AssetReturn = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-00512" title="Asset Return – Request & Approval Form">
      ...
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00512"
              title="ASSET RETURN – REQUEST & APPROVAL FORM"
              department="Asset Management – Asset Lifecycle"
            >

              {/* 1. Basic Info */}
              <div className="form-section">
                <h3 className="form-section-title">1. Return Information</h3>
...
export default FRM00512_AssetReturn;
