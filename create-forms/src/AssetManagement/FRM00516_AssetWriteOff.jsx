// FRM00516_AssetWriteOff.jsx
// FRM-00516 – Asset Write-Off – Request & Approval Form
...
const validationSchema = Yup.object({
  ...
  writeOffDate: Yup.string().required('Required'),
  ...
  conditionAssessment: Yup.string().required('Required'),
  supportingReference: Yup.string(),
...
const FRM00516_AssetWriteOff = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-00516" title="Asset Write-Off – Request & Approval Form">
      ...
      <Formik
        ...
        onSubmit={(values) => {
          console.log(values);
          alert('Asset Write-Off submitted successfully');
        }}
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00516"
              title="ASSET WRITE-OFF – REQUEST & APPROVAL FORM"
              department="Asset Management – Asset Lifecycle"
            >

              {/* 1. Basic Info */}
              <div className="form-section">
                <h3 className="form-section-title">1. Write-Off Information</h3>
                <div className="form-fields">
                  {field(values,'writeOffDate','Write-off Date','date')}
                      ...
                      <table className="items-table">
                        <thead>
                          <tr>
                            ...
                            <th>Book Value</th>
                            <th>Reason</th>
                            <th>Proposed Disposal Method</th>
                            <th>Remarks</th>
                        ...
                        <tbody>
                          {values.items.map((row, index) => (
                            <tr key={index}>
                              ...
                              <td><Field name={`items.${index}.reason`} className="form-input" /></td>
              ...
              <div className="form-section">
                <h3 className="form-section-title">3. Assessment Details</h3>
                <div className="form-fields">
                  {field(values,'conditionAssessment','Condition Assessment')}
...
export default FRM00516_AssetWriteOff;
