...
const validationSchema = Yup.object({
	...
	creditNoteReason: Yup.string().required('Credit Note Reason is required'),
	detailedDescriptionOfIssue: Yup.string().required('Detailed Description of Issue is required'),
	creditNoteAmountProposed: Yup.string().required('Credit Note Amount is required'),
	...
	return (
		...
		>
			...
			<Formik
				...
				onSubmit={(values) => {
					console.log('Credit note request submitted:', values);
					alert('Credit note request saved');
				}}
			>
				...
				{({ values, setFieldValue }) => (
					...
					<Form>
						...
						<ModernA4Template
							formId="FRM-02546"
							title="Credit Note Request – Request / Initiation Form"
						...
						>
							...
							{/* Credit Note Request Details */}
							<div className="form-section">
								<h3 className="form-section-title">Credit Note Request Details</h3>
								<div className="form-fields">

									<div className="form-field">
										<label className="form-label required">Credit Note Reason</label>
										{isPrintMode ? (
											<div className="print-value">{values.creditNoteReason || '___________________'}</div>
										) : (
											<Field name="creditNoteReason" as="select" className="form-input">
										...
										<ErrorMessage name="creditNoteReason" component="div" className="form-error" />
									</div>
									...
									<div className="form-field">
										<label className="form-label required">Credit Note Amount (Proposed)</label>
										{isPrintMode ? (
											<div className="print-value">{values.creditNoteAmountProposed || '___________________'}</div>
										) : (
											<Field name="creditNoteAmountProposed" className="form-input" />
										)}
										<ErrorMessage name="creditNoteAmountProposed" component="div" className="form-error" />
									</div>
									...
									<div className="form-field">
										...
										{isPrintMode ? (
											...
											<Field name="attachmentType" as="select" className="form-input">
												...
												<option value="Cancellation proof">Cancellation proof</option>
...
export default CreditNoteRequestForm;
