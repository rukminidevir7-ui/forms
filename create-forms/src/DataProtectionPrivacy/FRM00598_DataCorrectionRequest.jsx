// FRM00598_DataCorrectionRequest.jsx
// FRM-00598 – Data Correction Request Form
...
const validationSchema = Yup.object({
  ...
  dataField: Yup.string().required('Required'),
  currentValue: Yup.string().required('Required'),
  correctedValue: Yup.string().required('Required'),
...
const FRM00598_DataCorrectionRequest = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-00598" title="Data Correction Request – Request Form">
      ...
      >
        {({ values, setFieldValue }) => (
          <Form>
            ...
            <ModernA4Template
              formId="FRM-00598"
              title="DATA CORRECTION REQUEST – REQUEST FORM"
            ...
            >
              ...
              <div className="form-section">
                <h3 className="form-section-title">3. Correction Details</h3>
                <div className="form-fields">
                  {field(values,'dataField','Data Field to be Corrected')}
                  {field(values,'currentValue','Current Value')}
                  {field(values,'correctedValue','Corrected Value')}
                  {textarea(values,'reason','Reason for Correction')}
              ...
              <div className="form-section">
                <div className="print-value">
                  ...
                  correction of my personal data under applicable data protection regulations.
                </div>
              </div>
...
export default FRM00598_DataCorrectionRequest;
