// FRM01237_PostShipmentDocumentSetChecklist.jsx
// FRM-01237 – Post-shipment Document Set Checklist
...
const initialValues = {
  ...
  checklistItems: [
    ...
    { document: "Bank Documents (LC / Collection)", available: "", verifiedBy: "", remarks: "", dynamicFields: {} },
...
const FRM01237_PostShipmentDocumentSetChecklist = () => {
  ...
  return (
    <ModernFormWrapper
      formId="FRM-01237"
      title="Post-shipment Document Set Checklist"
    >
      <Formik
        ...
        onSubmit={(values)=>{
          console.log(values);
          alert("Post-shipment Document Checklist Submitted Successfully");
        }}
      >
              ...
              {!isPrintMode &&
                <div className="form-actions">
                  <button type="submit" className="btn-submit">
                    Submit Post-shipment Checklist
                  </button>
                </div>
              }
...
export default FRM01237_PostShipmentDocumentSetChecklist;