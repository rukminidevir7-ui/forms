// FRM01204_PackingListVerification.jsx
// FRM-01204 – Packing List Verification Checklist
...
const initialValues = {
  ...
  checklistItems: [
    { item: "Packing List Number Verified", status: "", remarks: "" },
    { item: "Exporter / Supplier Details Correct", status: "", remarks: "" },
    { item: "Consignee Details Correct", status: "", remarks: "" },
    { item: "Invoice Reference Matches", status: "", remarks: "" },
    { item: "Item Description Matches Invoice", status: "", remarks: "" },
    { item: "Quantity Verified", status: "", remarks: "" },
    { item: "Number of Packages Verified", status: "", remarks: "" },
    { item: "Net Weight Verified", status: "", remarks: "" },
    { item: "Gross Weight Verified", status: "", remarks: "" },
    { item: "Dimensions Verified", status: "", remarks: "" },
    { item: "Marks and Numbers Verified", status: "", remarks: "" },
    { item: "Packaging Type Verified", status: "", remarks: "" }
  ],
...
const FRM01204_PackingListVerification = () => {
  ...
  return (
    <ModernFormWrapper
      formId="FRM-01204"
      title="Packing List Verification Checklist"
    >
      <Formik
        ...
        onSubmit={(values)=>{
          console.log(values);
          alert("Packing List Verification Submitted Successfully");
        }}
      >
              ...
              {!isPrintMode &&
                <div className="form-actions">
                  <button type="submit" className="btn-submit">
                    Submit Packing List Verification
                  </button>
                </div>
              }
...
export default FRM01204_PackingListVerification;