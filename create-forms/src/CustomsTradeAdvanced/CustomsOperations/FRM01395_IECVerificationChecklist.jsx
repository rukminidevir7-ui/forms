// FRM01395_IECVerificationChecklist.jsx
// FRM-01395 – IEC Verification Checklist
...
const validationSchema = Yup.object({
  ...
  verificationDate: Yup.date().required("Required")
});
...
const FRM01395_IECVerificationChecklist = () => {
  ...
  return (
    <ModernFormWrapper formId="FRM-01395" title="IEC Verification Checklist">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("IEC Verification Checklist Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01395"
            title="FRM-01395 — IEC Verification Checklist"
          ...
          {/* 2. IEC Verification Checklist */}
          <div className="form-section">
            <h3 className="form-section-title">IEC Verification Checklist</h3>
          ...
          {/* 3. Overall Result */}
          <div className="form-section">
            <h3 className="form-section-title">Overall Result</h3>
            <div className="form-fields">

              <div className="form-field">
                <label className="form-label">Verification Status</label>
                {!isPrintMode ? (
                  <Field as="select" name="verificationStatus" className="form-input">
                    <option value="">Select</option>
                  ...
                  <div className="print-value">{values.verificationStatus || "_________"}</div>
                )}
              </div>
...
export default FRM01395_IECVerificationChecklist;