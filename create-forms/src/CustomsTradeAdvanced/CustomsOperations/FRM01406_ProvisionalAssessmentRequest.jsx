// FRM01406_ProvisionalAssessmentRequestChecklist.jsx
// FRM-01406 – Provisional Assessment Request Checklist
...
const initialValues = {
  ...
  /* 2. Provisional Assessment Checklist */
  checklistItems: [
...
const FRM01406_ProvisionalAssessmentRequestChecklist = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01406" title="Provisional Assessment Request Checklist">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Provisional Assessment Request Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01406"
            title="FRM-01406 — Provisional Assessment Request Checklist"
            department="Customs & Trade (Advanced) | Customs Operations"
          >

          {/* 1. Request Context */}
          <div className="form-section">
            <h3 className="form-section-title">Request Context</h3>
          ...
          {/* 2. Checklist */}
          <div className="form-section">
            <h3 className="form-section-title">Provisional Assessment Checklist</h3>
          ...
          {!isPrintMode &&
            <div className="form-actions">
              <button type="submit" className="btn-submit">
                Submit Provisional Assessment Checklist
              </button>
            </div>
          }
...
export default FRM01406_ProvisionalAssessmentRequestChecklist;