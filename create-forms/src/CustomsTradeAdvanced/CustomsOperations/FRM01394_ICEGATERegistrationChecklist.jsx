// FRM01394_ICEGATERegistrationChecklist.jsx
// FRM-01394 – ICEGATE Registration Checklist
...
const initialValues = {
  ...
  /* 2. ICEGATE Registration Checklist */
  checklistItems: [
    { item:"Valid IEC available", requirement:"", status:"", remarks:"", dynamicFields:{} }
  ],
...
const FRM01394_ICEGATERegistrationChecklist = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01394" title="ICEGATE Registration Checklist">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("ICEGATE Registration Checklist Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01394"
            title="FRM-01394 — ICEGATE Registration Checklist"
            department="Customs & Trade (Advanced) | Customs Operations"
          >

          {/* 1. Registration Context */}
          <div className="form-section">
            <h3 className="form-section-title">Registration Context</h3>
          ...
          {/* 2. ICEGATE Registration Checklist */}
          <div className="form-section">
            <h3 className="form-section-title">ICEGATE Registration Checklist</h3>
                ...
                <tbody>
                  {values.checklistItems.map((row,index)=>(
                    <tr key={index}>
                      ...
                      <td>
                        <Field name={`checklistItems.${index}.requirement`} className="form-input"/>
                      </td>
                      <td>
...
export default FRM01394_ICEGATERegistrationChecklist;