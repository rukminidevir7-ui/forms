// FRM01421_DutyDrawbackClaimDataPack.jsx
// Duty Drawback Claim Data Form – Universal
...
const FRM01421_DutyDrawbackClaimDataPack = () => {
  ...
  return(
    <ModernFormWrapper formId="FRM-01421" title="Duty Drawback Claim Data Form">
      <Formik
        initialValues={initialValues}
        validationSchema={validationSchema}
        onSubmit={(values)=>{
          console.log(values);
          alert("Duty Drawback Claim Submitted Successfully");
        }}
      >
      {({values,setFieldValue})=>(
        <Form>
          <ModernA4Template
            formId="FRM-01421"
            title="Duty Drawback Claim Data Form"
          ...
          <div className="form-section">
            ...
            <div className="form-fields">
              ...
              {field(values,"drawbackSerialNo","Drawback Serial No")}
            </div>
          </div>
              ...
              <div style={{marginBottom:15}}>
                ...
                <button
                  ...
                  onClick={()=>setFieldValue("claimItems",[
                    ...values.claimItems,
                    {productDescription:"",drawbackRate:"",claimAmount:"",calculationBasis:"",remarks:"",dynamicFields:{}}
                  ])}
                >
                  + Add Row
                </button>
                ...
                <tbody>
                  {values.claimItems.map((row,index)=>(
                    <tr key={index}>
                      ...
                      <td><Field name={`claimItems.${index}.drawbackRate`} className="form-input"/></td>
...
export default FRM01421_DutyDrawbackClaimDataPack;